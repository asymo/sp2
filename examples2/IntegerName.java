 ...
 * Based on material from "Java for Everyone" by Cay Horstmann.
 */
public class IntegerName {
    ...
    * @param digit an integer between 1 and 9 (both inclusive)
    * @return the name of digit ("one" ... "nine")
    */
   public static String digitName(int digit) {
      // (more efficient) alternative implementation via "switch" possible
      ...
      return ""; // TO DO: improve handling of illegal inputs using Exceptions
   }

   /**
    * Turns a number between 10 and 19 into its English name.
    * @param number an integer between 10 and 19 (both inclusive)
    ...
    * @param number an integer between 20 and 99 (both inclusive)
